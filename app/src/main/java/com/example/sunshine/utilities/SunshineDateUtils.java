...
public final class SunshineDateUtils {
    ...
    public static long getNormalizedUtcDateForToday() {
         ...
         */
        android.icu.util.TimeZone currentTimeZone = android.icu.util.TimeZone.getDefault();
    ...
    private static long getLocalMidnightFromNormalizedUtcDate(long normalizedUtcDate) {
        ...
        android.icu.util.TimeZone timeZone = TimeZone.getDefault();
        /*
    ...
    public static String getFriendlyDateString(Context context, long normalizedUtcMidnight, boolean showFullDate) {
        ...
        if (daysFromEpochToProvidedDate == daysFromEpochToToday || showFullDate) {
            ...
            if (daysFromEpochToProvidedDate - daysFromEpochToToday < 2) {
                 ...
                 */
                String localizedDayName = new android.icu.text.SimpleDateFormat("EEEE").format(localDate);
    ...
    private static String getDayName(Context context, long dateInMillis) {
        ...
        switch (daysAfterToday) {
            ...
            default:
                android.icu.text.SimpleDateFormat dayFormat = new SimpleDateFormat("EEEE");
